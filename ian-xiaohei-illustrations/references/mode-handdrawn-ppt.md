...
- Personagens: no máximo um leitor/engenheiro discreto; **花野稀泥 não é obrigatório** (e em geral não entra).  
...
- Title: "{título}"
- Labels: "{a}", "{b}", "{c}"
No extra paragraphs. No 花野稀泥 unless user asked. Clean, airy, one idea.
```
