...
|-------|------|----------------|--------|-------------|
| **Illustrations** (padrão desta skill) | [ian-xiaohei-illustrations](https://github.com/helloianneo/ian-xiaohei-illustrations) | 花野稀泥 **1.0** | Traço à mão em **branco puro**, diagrama-metáfora, rótulos vermelho/laranja/azul | Método, fluxo, estrutura, julgamento, comparação de produto, Clean Core, arquitetura conceitual |
| **Scenes** | [ian-xiaohei-scenes](https://github.com/helloianneo/ian-xiaohei-scenes) | 花野稀泥 **2.0** | **Objeto real** + 花野稀泥 + ação física + vazio (estúdio branco) | Situação humana, ansiedade, rework, reunião, overload, ressonância “é sobre mim”, metáfora de vivência |
| **Handdrawn PPT** | [ian-handdrawn-ppt](https://github.com/helloianneo/ian-handdrawn-ppt) | Páginas técnicas à mão (sem 花野稀泥 obrigatório) | Papel quase branco, linhas finas, pastéis, título + diagrama de página inteira | Capa 20:9 (Grok), deck de curso, “faça um PPT”, página de explicação técnica densa, contact sheet multipágina |
...
Usuário quer “cena real”, “objeto físico”, “situação de trabalho”, “long-scroll”, “história de projeto”, “花野稀泥 2.0”?
  → modo scenes
...
- “花野稀泥 2.0”, “cena física”, “estúdio com props”  
...
- menos foco no 花野稀泥; mais na **página técnica** com tipografia curta  
...
| 花野稀泥 mascote no handdrawn-ppt | PPT mode raramente usa personagem; no máximo um leitor/engenheiro discreto |
...
O modo escolhido não altera a identidade: use sempre 花野稀泥 e selecione exatamente uma variante, `backpack` ou `head-worn`, conforme `references/huayexini-variants.md`.